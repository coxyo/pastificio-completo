...
// Configura Socket.IO con CORS aggiornato
...
const corsOptions = {
  origin: function (origin, callback) {
    ...
    // Permetti origini specifiche
    if (allowedOrigins.indexOf(origin) !== -1) {
      callback(null, true);
    } else {
      callback(null, true); // Per debug, permetti tutto temporaneamente
    }
  },
  credentials: true,
...
// Gestione esplicita delle OPTIONS requests
