...
const SimpleDashboard = () => {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      const statsResponse = await fetch('${process.env.NEXT_PUBLIC_API_URL || "https://pastificio-completo-production.up.railway.app"}/api/dashboard/stats', { headers });
      ...
      if (statsResponse.ok) {
        ...
        const ordiniResponse = await fetch('${process.env.NEXT_PUBLIC_API_URL || "https://pastificio-completo-production.up.railway.app"}/api/ordini', { headers });
