...
export default function Dashboard() {
  ...
  const fetchData = async () => {
    try {
      // Step 1: Login
      const loginResponse = await fetch('${process.env.NEXT_PUBLIC_API_URL || "https://pastificio-completo-production.up.railway.app"}/api/auth/login', {
        method: 'POST',
      ...
      // Step 2: Get Orders
      const ordersResponse = await fetch('${process.env.NEXT_PUBLIC_API_URL || "https://pastificio-completo-production.up.railway.app"}/api/ordini', {
